/*
 * nfex_pp.c - post process nfex binaries looking for PE32s and malware
 *
...
next_entry:
	...
	for (i = 0; filename[i] == ' '; i++);
        ...
        /** MZ header always at 0x00 and 0x01 */
        ...
        /** PE header offset should be 60 bytes from start of file */
        if ((b[(b[60])]) == 0x50 && (b[(b[60]) + 1]) == 0x45)
        {
